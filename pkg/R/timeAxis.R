timeAxis <-
function (tmScl, whatTime, addTimeLine = "classic", l2r = FALSE, nmLim = 2, cexText = 0.5, srtText=0, cexTime = 0.5, cexLab = 0.5, whSpc=0.05, lwdLin=1, dumpLast=FALSE) 
  {
  #*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*
  #*#*#some initial conditions and initialize the plot
  if(l2r) xLm <- range(-tmScl$MA) else xLm <- range(0,1)
  if(l2r) yLm <- range(0,1) else yLm <- range(-tmScl$MA)
